...
const services: ServiceItem[] = [
  {
    ...
    desc: 'Debt counselling is a supportive, confidential process where financial experts evaluate your income, expenses, multiple outstanding debts, such as credit cards, personal loans, retail accounts and liabilities to help you regain control of your finances. It focuses on teaching you budget management, restructuring your habits, and laying the groundwork for customized repayment strategies to eliminate your financial stress.',
    ...
    steps: [
      ...
      },
      {
        ...
        desc: 'With clarity in place, we define your next steps. We present you with practical, structured debt solutions such as consolidation plans or structured repayment programs, designed to wipe out your debt and secure your financial future.'
      }
    ]
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        desc: 'We gather all necessary data and documentation regarding your existing liabilities. This includes statements, outstanding balances, and terms from your current creditors so we have clarity about your finance as to what you owe.'
      },
      {
      ...
      },
      {
        ...
        desc: 'Finally, our team of experienced financial experts designs a customized consolidation action plan. Once approved by our team, we execute the strategy to merge your debts and lower your financial stress.'
      }
    ]
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        desc: 'Based on the client\'s consensual authority, we contact the concerned financial institutions to audit the current status of your debt file. This allows us to establish the exact, verified amount payable, stripping away unfair penalties or hidden fees.'
      },
      {
        title: '3. Aggressive Negotiation & Formal Offer',
        desc: 'Our experienced consultants review to secure the maximum possible reduction on your outstanding balance. We don\'t stop until we secure a formal, written settlement offer from the bank or creditor confirming the reduced final settlement offer.'
      },
      {
        title: '4. Settlement & Final Clearance Letter',
        desc: 'Based on the formal offer letter received, we proceed towards navigating the client towards payment of the debt to settle and close the liability account. Once it is paid, we initiate the process to mentor the client to ensure that the financial institution issues an official No Liability / Debt settlement letter. This vital document serves as your legal proof that the debt has been fully settled and closed forever.'
      }
    ]
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        desc: 'We analyze the math behind your finances. By testing the compatibility between your total debt obligations and your actual net income, we calculate a realistic, sustainable monthly payment that covers your living expenses while matching creditors terms.'
      },
      {
        title: '4. In-House Strategy & Bank Negotiation',
        desc: 'After a robust in-house consultancy session to lock down your custom restructuring strategy. With client’s consent, our expert financial consultants initiate formal discussions with your concerned financial institutions. Based on the client\'s consensual authority, we advocate on your behalf to negotiate to structure newly modified terms that fit your budget.'
      }
    ]
  }
];
